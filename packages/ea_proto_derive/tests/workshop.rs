...
impl CoreImpl {
    ...
    async fn list_countries(
        &self,
        _data: &pb::ListCountriesRequest,
        _page_size: i64,
    ) -> DbResult<Vec<CountryRaw>> {
        unimplemented!()
    }
    ...
    async fn create_country(
        &self,
        _data: &pb::CreateCountryRequest,
    ) -> DbResult<Country> {
        unimplemented!()
    }

    async fn soft_delete_country(
        &self,
        _data: &pb::DeleteCountryRequest,
    ) -> DbResult<Country> {
        unimplemented!()
    }
